...
INSERT INTO tours (tour, descripcion, duracion, precio, categoria, activo) VALUES (
    'Machupicchu | Full Day todo inlcuido con tren Turístico de Perú Rail o Inca Rail', 
    'recojo de hotel viaje en bus aprox 1 hora con 30 minutos, subir al tren viaje de 2 horas, abordar bus turistico de macupicchu pueblo a machu picchu viaje de 30 minutos, en machupicchu se recorrera todo los principales sitios turisticos en compañia del guia, tendran tiempo de tomarse fotos, se tomara el bus de retorno a machu picchu pueblo donde se almorzara luego tomaran el tren de regreso a Cusco.', 24, 275, 'Caminata', 1);
INSERT INTO tours (tour, descripcion, duracion, precio, categoria, activo) VALUES (
    'Machu Picchu by Car | Ruta Amazónica En Bus, Hidroeléctrica', 'Dia1: recojo de hotel 6:20 am, pasaran por chinchero, el valle sagrado, olantaytambo con una parada para relajarse y comprar algo, pasaran por Habrá de Málaga que esta a 4.316 metros sobre el nivel del mar, descenso a la selva alta hazta el pueblo de Santa Maria, se descansara, se continuara el viaje hazta el pueblo de Santa Teresa, se almorzara, a las 3 pm se inica la caminata de 2 horas con 40 minutos a Machu Picchu pueblo, se llegara al hospedaje 8 pm para cenar y dormir. Dia2: se levantan temprano para tomar el bus de machu picchu pueblo a machupicchu, se conocera machupicchu hazta las 11:30 am, se descendera en bus o caminando a machu picchu pueblo, se tomara tren de machu picchu pueblo a la central de hidroeléctrica a las 12:35 pm, tomamos el tranporte de retorno a la ciudad del cusco, se llegara 9:45 pm', 57, 120, 'Caminata', 1);
INSERT INTO tours (tour, descripcion, duracion, precio, categoria, activo) VALUES (
    'Tour Cuatrimotos Maras Moray | Moray, Salineras de Maras, Terrazas Incas de Zurite, Huarocondo y Laguna de Huaypo en Tour Exclusivo Privado', 'Recojo de hotel, viaje de 45 minutoas a la oficina en Anta, se le brinda toda la informacion y recomendaciones, practica en las cuatrimotoas, se diregen en cuatrimotos a las terrazas incas de Zurite, se dirigen al pueblo de Huarocondo, se camina por le purblo de Huaroncondo, se dirigen a Moray pasando por los pueblos de Anta y Maras, se dirigiran a Misminay y se almorzara ahi, se dirigiran a las minas de sal y moray, se dirigiran a la laguna de Huaypo, se dirigiran a la base en Anta, total se viajo 64 kilometros, el transporte les llevara a su hotel', 24, 177, 'Aventura', 1);
INSERT INTO tours (tour, descripcion, duracion, precio, categoria, activo) VALUES (
    'Tours en Cuatrimotos | Tour en Cuatrimoto Killarumiyoq | más los andenes Incas de Zurite, Qente Qenteyoc y el Pueblo Colonial de Zurite en un Tour Privado Exclusivo', 'Recojo en hotel, viaje de 55 minutos a la oficina en Anta, se brinda información sobre el tour, se conduce por la pampa de anta a las Terrazas Incas de Zurite donde se preservan semillas nativas, se visita Qente Qenteyoc sitio espiritual dedicado al colibrí, se visita el templo de la luna Killarumiyoq, en el camino de regreso nos detendremos en el pueblo colonial de Zurite para caminar y tomar fotos, se llega a la oficina de Anta  para regresar a nuestro hotel, se recorren 45 kilómetros en cuatrimoto. ', 12, 85, 'Aventura', 1);
INSERT INTO tours (tour, descripcion, duracion, precio, categoria, activo) VALUES (
    'Tour Cuatrimotos Laguna Huaypo | Terrazas Incas de Zurite, Pueblo Colonial de Huarocondo y Hermosas Comunidades Andinas en un Tour Exclusivo Privado', 'Recojo en Cusco o Valle Sagrado, traslado a Anta (55 min), Instrucciones y práctica en cuatrimotos por 10 minutos, Recorrido en cuatrimoto por las pampas de Anta, visita a las terrazas Incas de Zurite, nos dirigiremos al pueblo colonial de Huarocondo, se camaniara por el pueblo, asenderemos por los pueblos andinois de Anta y Maras para llegar a la Laguna de Huaypo, actividades acuáticas y tiempo libre. Retorno a la base de Anta por una ruta diferente. Traslado de regreso al hotel. ', 12, 75, 'Aventura', 1);
INSERT INTO tours (tour, descripcion, duracion, precio, categoria, activo) VALUES (
    'Tour Cuatrimotos Maras, Moray y Salineras 1/2 Dia | Visite Moray, Salineras o Laguna de huaypo mas salineras en servicio grupal economico', 'Recojo de hotel, viaje de 55 minutos a la base en Maras, se brinda información y recomendaciones, práctica en las cuatrimotos, recorrido hacia las terrazas incas de Moray donde se pasara por los paisajes de Maras, regreso a la base, se continúa en transporte privado hacia las minas de sal debido a restricciones para cuatrimotos, luego se regresa a nuestro hotel. ', 12, 35, 'Aventura', 1);
INSERT INTO tours (tour, descripcion, duracion, precio, categoria, activo) VALUES (
    'Parapente en Cusco | Parapente en el Valle Sagrado y Rahuanqui de Anta | en servicio Grupal', 'Recojo de hotel entre 6:15 y 6:30 A.M, viaje de una hora a la cima de la montaña sobre el Valle Sagrado, charla con los pilotos, se coloca el equipo y se vuela sobre los paisajes del Valle Sagrado. Se recomienda llevar una GoPro, se toma el transporte a su hotel. ', 12, 99, 'Aventura', 1);
INSERT INTO tours (tour, descripcion, duracion, precio, categoria, activo) VALUES (
    'Parapente en Cusco | Parapente en el Valle Sagrado y Rahuanqui de Anta | Exclusivo Privado', 'Recojo de hotel entre (7 a 8 A.M), viaje de una hora a la cima de la montaña sobre el Valle Sagrado, charla con los pilotos, se coloca el equipo y se vuela sobre los andenes incas de Zurite en Eco Park de Rahuanqui y se toma el transporte de retorno a nuestro hotel. ', 12, 175, 'Aventura', 1);
INSERT INTO tours (tour, descripcion, duracion, precio, categoria, activo) VALUES (
    'Tour a caballo en Valle Sagrado | Maras Moray, Salineras y Chinchero en Servicio Exclusivo Privado', 'Recojo de hotel, viaje de 55 minutos a Chinchero para visitar el centro textil y aprender sobre los tejidos y técnicas de teñido Inca. Se visita el pueblo de Chinchero y luego se viaja a Maras, donde esperan los Caballos de Paso Peruano. Tras una charla informativa, se monta a caballo hacia las terrazas circulares de Moray. Después, se retorna a Maras y se visita las Salineras de Maras, con aproximadamente 4000 piscinas. Finalmente, retorno en transporte privado al hotel en Cusco o Valle Sagrado.', 24, 145, 'Aventura', 1);
INSERT INTO tours (tour, descripcion, duracion, precio, categoria, activo) VALUES (
    'Tour a Caballo en el Valle Sagrado | Laguna de Huaypo, Mirador del Valle Sagrado y Chinchero en Servicio Exclusivo Privado', 'Recojo de hotel, viaje de 55 minutos a Chinchero para aprender sobre tejidos incas y técnicas de teñido. Visita al pueblo de Chinchero, luego viaje a Maras Moray para montar Caballos de Paso Peruano. Se cabalga a orillas de la Laguna de Huaypo y se sigue por un sendero hasta un mirador con vistas del Valle Sagrado y los nevados Chicon, Pitusiray y Veronica. Todo el tour es guiado, y al final se regresa al hotel en Cusco o Valle Sagrado.', 12, 135, 'Aventura', 1);
INSERT INTO tours (tour, descripcion, duracion, precio, categoria, activo) VALUES (
...
INSERT INTO tours (tour, descripcion, duracion, precio, categoria, activo) VALUES (
    'Tour Montaña 7 Colores Full Day | Como llegar a la montaña de 7 colores desde Cusco | en Tour exclusivo Privado', 'Recojo de hotel en Cusco a las 8:00 o 9:00 a.m., viaje de 3 horas hasta Tintinco en Cusipata. Caminata de 2 horas hacia la Montaña Vinicunca, se recomienda alquilar un caballo para facilitar el ascenso. El sendero ofrece paisajes coloridos, riachuelos y vistas de los Andes, con llamas, alpacas y vicuñas. En el punto más alto se disfruta de la vista de la Montaña Arcoíris. Después de tomar fotos, se desciende a Huachipata para almorzar, y luego se regresa a Cusco. El tour privado ofrece un horario flexible y asistencia profesional', 24, 115, 'Caminata', 1);
INSERT INTO tours (tour, descripcion, duracion, precio, categoria, activo) VALUES (
    'Tour Montaña 7 Colores Full Day | Como llegar a la montaña de 7 colores desde Cusco | En Tour Economico Grupal', 'Recojo temprano de hotel en Cusco, seguido de un viaje de 3 horas a Tintinco en Cusipata para disfrutar de un desayuno. Luego, comienza una caminata de 3 horas hacia la Montaña Vinicunca, atravesando paisajes coloridos y riachuelos. Durante el ascenso, se podrán ver llamas, alpacas y vicuñas, junto con impresionantes vistas de los Andes y montañas glaciares. Al llegar al punto más alto, se aprecia la Montaña Arcoíris (Vinicunca) y se toman fotos. Después, se desciende a Huachipata para almorzar y se regresa a Cusco', 24, 30, 'Caminata', 1);
INSERT INTO tours (tour, descripcion, duracion, precio, categoria, activo) VALUES (
    'Turismo Vivencial Cusco – Turismo Vivencial en Cusco Perú Maras Moray, Chinchero, Mullacas Misminay en Tour Exclusivo Privado 2D/1N', 'Día 1: Recojo de los clientes desde el aeropuerto u hotel en Cusco o el Valle Sagrado. Visita al centro textil y las ruinas incas en Chinchero. Luego, visita a los sitios arqueológicos de Maras Moray y las Salineras del Valle Sagrado. Llegada a la comunidad de Mullacas Misminay, donde serán recibidos con música, bailes y vestimenta tradicional. Almuerzo típico de Pachamanca. Por la noche, cena familiar alrededor de un fuego con historias y leyendas locales. Día 2: Desayuno tradicional andino en la casa familiar. Participación en dos actividades:Actividad 1: Demostración de textiles, donde aprenderán sobre las técnicas de preparación de lana y el uso de tintes naturales, realizada por mujeres de la comunidad. Actividad 2: Demostración de agricultura, donde conocerán las técnicas ancestrales en las fincas y podrán participar en las actividades agrícolas. Retorno a su hotel en Cusco o el Valle Sagrado en la tarde, concluyendo el tour. ', 54, 299, 'Vivencial', 1);
INSERT INTO tours (tour, descripcion, duracion, precio, categoria, activo) VALUES (
    'Turismo Vivencial Cusco – Turismo Vivencial en Mullacas Misminay full day en servicio Exclusivo Privado', 'El viaje inicia con la recogida de los clientes en el aeropuerto de Cusco o en hoteles de la ciudad o Valle Sagrado. Se visita el pueblo Inca de Chinchero, donde se exploran un centro textil y las ruinas incas. Luego, se dirigen a los sitios arqueológicos de Maras, Moray y las Salineras de Maras. A continuación, los visitantes llegan a la comunidad de Mullacas Misminay, donde son recibidos con música y danzas tradicionales. El almuerzo consiste en Pachamanca, un platillo típico preparado con carne, especias y productos andinos, cocidos con piedras. Las actividades incluyen: Demostración de Textiles: Aprendizaje sobre técnicas tradicionales de extracción de lana y uso de tintes naturales, realizado por mujeres de la comunidad. Demostración de Agricultura: Conocimiento sobre técnicas ancestrales y herramientas utilizadas en la agricultura local, con la oportunidad de participar. Al final de la tarde, se regresa en transporte privado al hotel en Cusco o Valle Sagrado. 
', 24, 129, 'Vivencial', 1);
INSERT INTO tours (tour, descripcion, duracion, precio, categoria, activo) VALUES (
    'Turismo Vivencial Cusco – Turismo Vivencial en Cusco Perú – en el pueblo Colonial de Huarocondo en la Provincia de Anta, en servicio Exclusivo Privado', 'Recojo de clientes en el aeropuerto de Cusco o en hoteles de Cusco y Valle Sagrado. Visita a las Terrazas Incas de Zurite, utilizadas por los Incas como laboratorio agrícola y todavía en uso para preservar semillas nativas. Después, se visita el pueblo colonial de Huarocondo. Luego, se dirigen a la comunidad de Marjko, donde son recibidos con música, bailes y vestimenta típica. Almuerzo: Disfrutan de la pachamanca, un platillo ancestral que incluye carne, papas, camote y otros ingredientes andinos, cocidos con piedras precalentadas. Actividades: 1. Ordeño de vacas: Aprenderán técnicas tradicionales de ordeñar, guiados por mujeres del pueblo. 2. Preparación de quesos andinos: Demostración de técnicas ancestrales en la elaboración de quesos. Transporte de regreso a su hotel en Cusco o Valle Sagrado.', 24, 115, 'Vivencial', 1);
INSERT INTO tours (tour, descripcion, duracion, precio, categoria, activo) VALUES (
    'Tour Valle Sagrado de los Incas | Tour al Valle Sagrado de los Incas Full Day | Pisac, Ollantaytambo y Chinchero en Tour Economico Grupal', 'Inicio del tour a las 8:30 a.m. con recojo de hoteles. Primera parada en el mirador de Taray para disfrutar del Valle Sagrado. Visita al Mercado Artesanal de Pisac, donde se encuentran diversas artesanías. Luego, recorrido por el sitio arqueológico de Pisac con un guía profesional que explica sobre el pueblo inca y sus terrazas agrícolas. Almuerzo en un restaurante turístico en Urubamba. Continuamos hacia Ollantaytambo para apreciar el templo del sol. Antes de regresar a Cusco, parada en Chinchero para visitar una casa textil y el pueblo inca. Llegada a Cusco alrededor de las 7:00 p.m., cerca de la plaza principal. No incluye: Boleto de Ingreso a los parques Arqueológicos (70 Soles)', 24, 35, 'Caminata', 1);
INSERT INTO tours (tour, descripcion, duracion, precio, categoria, activo) VALUES ('Tour Valle Sagrado de los Incas | Tour al Valle Sagrado de los Incas Full Day | Pisac, Ollantaytambo y Chinchero en Tour Privado', 'Inicio del tour a las 8:30 a.m. con recojo de hoteles. Primera parada en el mirador de Taray para disfrutar del Valle Sagrado. Visita al Mercado Artesanal de Pisac, donde se encuentran diversas artesanías. Luego, recorrido por el sitio arqueológico de Pisac con un guía profesional que explica sobre el pueblo inca y sus terrazas agrícolas. Almuerzo en un restaurante turístico en Urubamba. Continuamos hacia Ollantaytambo para apreciar el templo del sol. Antes de regresar a Cusco, parada en Chinchero para visitar una casa textil y el pueblo inca. Llegada a Cusco alrededor de las 7:00 p.m., cerca de la plaza principal. No incluye: Boleto de Ingreso a los parques Arqueológicos (70 Soles) En nuestro Tour Privado Exclusivo, la salida es a la mejor hora del Cliente con paradas muy flexibles en cada sitio y podemos iniciar el tour desde la ciudad de Cusco o desde su lindo hotel del Valle Sagrado.', 24, 115, 'Caminata', 1);
